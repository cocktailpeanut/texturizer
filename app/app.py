    ...
    with gr.Blocks(title="Texturizer") as demo:
        ...
        with gr.Row():
            with gr.Column():
                ...
                submit = gr.Button("Texturize", variant="primary")
            with gr.Column():
                conditioning_output = gr.Image(label="Source or conditioning image")
                model_output = gr.Model3D(label="Final GLB preview")
        ...
        submit.click(
            fn=run_ui,
            inputs=[mesh_input, image_input, prompt_input, texture_mode_input, preserve_rig_input],
